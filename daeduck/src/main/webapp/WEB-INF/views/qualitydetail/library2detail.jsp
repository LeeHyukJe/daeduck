                            ...
                            <tbody>
                                ...
                                <tr style="height:28px">
                                    ...
                                    <td style="background-color:#fff">
                                        <select name="processname" id="cphContent_cphContent_ddlProcessName"
                                ...
                                <tr style="height:28px">
                                    ...
                                    <td style="background-color:#fff">
                                        <input name="ctl00$ctl00$cphContent$cphContent$txtFTIR_Result" type="text"
                                            id="cphContent_cphContent_txtFTIR_Result" style="width:95%;">
                                    </td>
                                </tr>
                                <tr style="height:28px">
                                ...
                                <tr style="height:28px">
                                    ...
                                    <td style="background-color:#fff">
                                        <input name="entry_no" type="text"
                                            id="entry_no" style="width:95%;">
                                    </td>
                                </tr>
                                <tr style="height:28px">
